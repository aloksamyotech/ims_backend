...
subscriptionRouter.patch("/update/:id", SubscriptionController.updatedSubscription);
subscriptionRouter.get("/fetchById/:id", SubscriptionController.fetchById_subsription);
subscriptionRouter.get("/count", SubscriptionController.getSubscriptionCount);
subscriptionRouter.delete("/deleteById/:id",SubscriptionController.deleteSubscription);
